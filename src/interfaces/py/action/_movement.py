...
class Metaclass_Movement_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('legs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Movement_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from legs.action import Movement
...
class Movement_SendGoal_Request(metaclass=Metaclass_Movement_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'legs/Movement_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['legs', 'action'], 'Movement_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from legs.action._movement import Movement_Goal
...
class Metaclass_Movement_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from legs.action import _movement
...
class Movement_SendGoal(metaclass=Metaclass_Movement_SendGoal):
    from legs.action._movement import Movement_SendGoal_Request as Request
    from legs.action._movement import Movement_SendGoal_Response as Response
...
class Movement_GetResult_Response(metaclass=Metaclass_Movement_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'legs/Movement_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['legs', 'action'], 'Movement_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from legs.action._movement import Movement_Result
...
class Metaclass_Movement_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'legs.action.Movement_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Movement_GetResult(metaclass=Metaclass_Movement_GetResult):
    from legs.action._movement import Movement_GetResult_Request as Request
    from legs.action._movement import Movement_GetResult_Response as Response
...
class Metaclass_Movement_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'legs.action.Movement_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Movement_FeedbackMessage(metaclass=Metaclass_Movement_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'legs/Movement_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['legs', 'action'], 'Movement_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from legs.action._movement import Movement_Feedback
...
class Movement(metaclass=Metaclass_Movement):
    ...
    from legs.action._movement import Movement_Goal as Goal
    # The result message defined in the action definition.
    from legs.action._movement import Movement_Result as Result
    # The feedback message defined in the action definition.
    from legs.action._movement import Movement_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from legs.action._movement import Movement_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from legs.action._movement import Movement_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from legs.action._movement import Movement_FeedbackMessage as FeedbackMessage
